...
class AutoEncoder(tf.keras.Model):
    ...
    def encode(self, X1, X2):
        ...
        self.l3 = l3
        # print("layer3 shape", l3.shape)
        return l3  # if we can use self.l3
    ...
    def train(self, train_index, val_index):
        ...
        while epoch < self.max_epochs and stop == False:
            ...
            for sample in mini_batches:
                ...
                cost_val = tf.reduce_mean(self.loss(batch_xs1, batch_xs2))
            ...
            # print("++++++++++++++++++++++++The end of one 'for' iteration++++++++++++++++++++++++++++++++++")
        ...
        # print("---------------End test----------")
        # print("The value of histcosts", self.histcosts )
        # for display in self.histcosts:
        # print(display.numpy)
        # print("The value of histvalcosts", self.histvalcosts)
        # for displayval in self.histvalcosts:
        # print(displayval.numpy)
        # print("---------------End test in history displaying----------")
    ...
    def cross_validation(self, params):
        ...
        print("************************The crossvalidation ->hiscosts:*********************")
        print(hist_costs)
        print("************************The crossvalidation ->hist_val_costs:*********************")
...
if __name__ == '__main__':
    ...
    f = open(
        r'C:\Users\gklizh\Documents\Workspace\code_and_data\data\python_related\result\comm_parameter_binary11.txt',
        'w+')
    f.close()
    ...
    for iterator in range(21):
        ...
        if htseq_nbr > 1 and methy_nbr > 1:
            ...
            print("---------Start trial----------------")
            best = fmin(sae.cross_validation, space, algo=tpe.suggest, max_evals=3, trials = trials[trial_label])
            ...
            # save the best HPs
            # fname = (r'C:\Users\gklizh\Documents\Workspace\code_and_data\data\python_related\result\comm_trials_binary_test06.pkl')
            ...
            print("-------------Time count--------------------")
            # f1 = open(r'C:\Users\gklizh\Documents\Workspace\code_and_data\data\python_related\result\comm_parameter_binary_backup.txt',
            #     'a+')
            # print("---------open the file to load the best items in best-----------------------------")
