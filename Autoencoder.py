...
class AutoEncoder(tf.keras.Model):
    ...
    def get_weights(self):
        ...
        self.W1 = self.l1_layer.get_weights()[0]
        #print("W1 is :",len(self.W1))
        #print(self.W1)
        #print(self.W1[0])
        #print(self.W1[1])
        self.W2 = self.l2_layer.get_weights()[0]
        self.Wsht = self.l3_layer.get_weights()[0]
        self.Wsh = self.l4_layer.get_weights()[0]
        self.W1t =self.l5_layer.get_weights()[0]
        self.W2t =self.l6_layer.get_weights()[0]
